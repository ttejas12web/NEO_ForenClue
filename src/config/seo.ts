...
export const ROUTE_SEO_CONFIG: Record<string, RouteSEOConfig> = {
  ...
  '/courses': {
    ...
    image: 'https://forenclue.in/og/courses.png',
    type: 'course',
  ...
  '/cases': {
    ...
    image: 'https://forenclue.in/og/cases.png',
    type: 'article',
  ...
  '/ebooks': {
    ...
    image: 'https://forenclue.in/og/ebooks.png',
    type: 'book',
  ...
  '/podcast': {
    ...
    image: 'https://forenclue.in/og/podcast.png',
    type: 'website',
  ...
  '/webinar': {
    ...
    image: 'https://forenclue.in/og/webinar.png',
    type: 'website',
  ...
  '/services': {
    ...
    image: 'https://forenclue.in/og/services.png',
    type: 'service',
  ...
  '/about': {
    ...
    image: 'https://forenclue.in/og/about.png',
    type: 'website',
  ...
  '/careers': {
    ...
    image: 'https://forenclue.in/og/careers.png',
    type: 'website',
  ...
  '/contact': {
    ...
    image: 'https://forenclue.in/og/contact.png',
    type: 'website',
  ...
  '/certificate': {
    ...
    image: 'https://forenclue.in/og/certificate.png',
    type: 'website',
  ...
  '/simulations': {
    ...
    image: 'https://forenclue.in/og/simulations.png',
    type: 'website',
  ...
  '/simulations/stereo-microscope': {
    ...
    image: 'https://forenclue.in/og/microscope.png',
    type: 'website',
  ...
  '/simulations/spectrophotometer': {
    ...
    image: 'https://forenclue.in/og/spectrophotometer.png',
    type: 'website',
  ...
  '/employees': {
    ...
    image: 'https://forenclue.in/og/employees.png',
    type: 'website',
  ...
  '/volunteers': {
    ...
    image: 'https://forenclue.in/og/volunteers.png',
    type: 'website',
  ...
  '/ambassadors': {
    ...
    image: 'https://forenclue.in/og/ambassadors.png',
    type: 'website',
  ...
  '/privacy': {
    ...
    image: 'https://forenclue.in/og/privacy.png',
    type: 'website',
  ...
  '/terms': {
    ...
    image: 'https://forenclue.in/og/terms.png',
    type: 'website',
  ...
  '/refund-policy': {
    ...
    image: 'https://forenclue.in/og/refund.png',
    type: 'website',
  ...
  '/return-policy': {
    ...
    image: 'https://forenclue.in/og/return.png',
    type: 'website',
  ...
  '/shipping-policy': {
    ...
    image: 'https://forenclue.in/og/shipping.png',
    type: 'website',
  ...
  '/login': {
    ...
    image: 'https://forenclue.in/og/login.png',
    type: 'website',
  ...
  '/dashboard': {
    ...
    image: 'https://forenclue.in/og/dashboard.png',
    type: 'website',
  ...
  '/profile': {
    ...
    image: 'https://forenclue.in/og/profile.png',
    type: 'website',
